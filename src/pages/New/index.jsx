...
export function New() {
  ...
  async function handleNewNote() {
    ...
    alert('Nota enviado com sucesso!')
    navigate(-1)
  }
          ...
          <Section title="Links uteis">
            {
              links.map((link, index) => (
                <NoteItem value={link} onClick={() => handleRemoveLink(link)} key={String(index)}/>
              ))
            }
            <NoteItem value={newLink} isNew placeholder="Novo link" onChange={e => setNewLink(e.target.value)} onClick={handleAddLink}/>
          </Section>
